          ...
          <div className="grid md:grid-cols-2 gap-12 items-center w-full">
            ...
            >
              <div className="space-y-4">
                ...
                >
                  Share your thoughts securely and privately using our advanced anonymous verification system.
                </motion.p>
              </div>
              ...
              <div className="aspect-square relative">
                ...
                >
                  ...
                  <circle r="4" cx="69.28" cy="-40" fill="#60A5FA">
                    <animate attributeName="opacity" values="0.3;1;0.3" dur="2s" repeatCount="indefinite" begin="0.33s" />
                  </circle>
                  <circle r="4" cx="69.28" cy="40" fill="#60A5FA">
                    <animate attributeName="opacity" values="0.3;1;0.3" dur="2s" repeatCount="indefinite" begin="0.66s" />
                  </circle>
                  <circle r="4" cx="0" cy="80" fill="#60A5FA">
                    <animate attributeName="opacity" values="0.3;1;0.3" dur="2s" repeatCount="indefinite" begin="1s" />
                  </circle>
                  <circle r="4" cx="-69.28" cy="40" fill="#60A5FA">
                    <animate attributeName="opacity" values="0.3;1;0.3" dur="2s" repeatCount="indefinite" begin="1.33s" />
                  </circle>
                  <circle r="4" cx="-69.28" cy="-40" fill="#60A5FA">
                    <animate attributeName="opacity" values="0.3;1;0.3" dur="2s" repeatCount="indefinite" begin="1.66s" />
                  </circle>
                </motion.svg>
